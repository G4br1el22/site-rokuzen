...
//Create
const postNovoAtendimento = async(inicio_atendimento, fim_atendimento, pagamento, id_servico, id_cliente, id_colaborador, id_sala, id_unidade) =>{
        try{
...
//Update
const updateAtendimento = async(inicio_atendimento, fim_atendimento, pagamento, id_servico, id_cliente, id_colaborador, id_sala, id_unidade, id_atendimento) => {
    try{
...
module.exports = {postNovoAtendimento, getInformacoesPorIdColaborador, getInformacoesPorIdUnidade, updateAtendimento, deleteAtendimento};