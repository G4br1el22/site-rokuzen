...
//Create 
const createServico = async(tipo_servico, preco_servico, tempo_servico, pontuacao)=>{
    try{
...
//Read
const getServicos = async(tipo_servico, preco_servico, tempo_servico, pontuacao) =>{
    try{
...
//Update
const updateServicos = async(tipo_servico, preco_servico, tempo_servico, pontuacao, id_servico)=>{
    try{
...
//Delete
const deleteServicos = async(id_servico)=>{
    try{
...
module.exports = {createServico, getServicos, updateServicos, deleteServicos};