...
//Create
const createSala = async(tipo_sala, disponivel_sala, id_unidade)=>{
    try{
...
//Read
const getSalasPorUnidadesID = async(id_unidade)=>{
    try{
...
//Update
const updateDisponibilidade = async(disponivel_sala, id_sala)=>{
    try{
...
module.exports = {createSala, getSalasPorUnidadesID, updateDisponibilidade};