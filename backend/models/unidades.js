...
//Create
const createUnidade = async(nome_unidade)=>{
    try{
...
//Read
const getUnidade = async(id_unidade)=>{
    try{
...
//Update
const updateUnidade =  async(nome_unidade, id_unidade)=>{
    try{
...
//Delete
const deleteUnidade = async(id_unidade)=>{
    try{
...
module.exports = {createUnidade, getUnidade, updateUnidade, deleteUnidade};